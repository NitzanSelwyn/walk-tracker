...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-50 px-4">
      ...
      <button
        ...
        className="mt-4 rounded-md px-3 py-1.5 text-sm text-gray-500 hover:bg-white/50"
      >
